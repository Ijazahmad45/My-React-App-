...
export default function About(props) {
          ...
          // const [myStyle, setMyStyle] = useState({
            ...
            let myStyle ={
                ...
                backgroundColor : props.mode === 'dark'?'#244969':'white'
            }
           ...
           <h1 className='my-3 ' style={{color : props.mode === 'dark'?'white':'#042743'}} >About Us</h1>
            <div>
                ...
                <div className="accordion-item">
                    ...
                    <div className="accordion-body" style={myStyle}>
                    TextUtils is a free characters counter tool that provides instant characters count and word count
                    statistics for a given text. TextUtils reports the number of words and characters. Thus it is suitable
                    for writing text with words/ character limit.   
                    </div>
                    </div>
                </div>
                <div className="accordion-item">
